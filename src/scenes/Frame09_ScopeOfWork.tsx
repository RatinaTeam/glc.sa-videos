...
export const Frame09_ScopeOfWork: React.FC<{ audioSrc: string }> = ({ audioSrc }) => {
    ...
    const tags = ["Architectural", "Structural", "Electrical", "Mechanical"];
    ...
    return (
        <SlideWrapper audioSrc={audioSrc}>
            <AbsoluteFill style={{ justifyContent: 'center', alignItems: 'center' }}>
                ...
                >
                    All plans designed & approved by competent authorities.
                </Body>
            </AbsoluteFill>
        </SlideWrapper>
    );
